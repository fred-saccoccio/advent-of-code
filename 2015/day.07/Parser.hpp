  ...
  private:
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_USHORT: // USHORT
        value.move< unsigned short > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, unsigned short&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const unsigned short& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    {
      ...
      case symbol_kind::S_USHORT: // USHORT
        value.template destroy< unsigned short > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {}
#if 201103L <= YY_CPLUSPLUS
      symbol_type (int tok, unsigned short v)
        : super_type (token_kind_type (tok), std::move (v))
#else
      symbol_type (int tok, const unsigned short& v)
        : super_type (token_kind_type (tok), v)
#endif
      {}
    };
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_OP_RSHIFT ()
      {
        return symbol_type (token::OP_RSHIFT);
      }
#else
      static
      symbol_type
      ...
      make_OP_LSHIFT ()
      {
        return symbol_type (token::OP_LSHIFT);
      }
#else
      static
      symbol_type
      ...
      make_CONNECT ()
      {
        return symbol_type (token::CONNECT);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_USHORT (unsigned short v)
      {
        return symbol_type (token::USHORT, std::move (v));
      }
#else
      static
      symbol_type
      make_USHORT (const unsigned short& v)
      {
        return symbol_type (token::USHORT, v);
      }
#endif
